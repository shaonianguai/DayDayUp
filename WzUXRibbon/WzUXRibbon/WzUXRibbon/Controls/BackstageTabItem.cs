...
namespace WzUXRibbon.Controls
{
    ...
    public class BackstageTabItem : ContentControl, IHeaderedControl, IKeyTipedControl, ILogicalChildSupport
    {
        ...
        /// </summary>
        public static readonly DependencyProperty KeyTipProperty = WzUXRibbon.Controls.KeyTip.KeysProperty.AddOwner(typeof(BackstageTabItem));
        ...
        /// <inheritdoc />
        protected override AutomationPeer OnCreateAutomationPeer() => new WzUXRibbon.Automation.Peers.RibbonBackstageTabItemAutomationPeer(this);
    }
}
