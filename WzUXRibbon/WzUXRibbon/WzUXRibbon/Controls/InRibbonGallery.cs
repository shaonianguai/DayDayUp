...
namespace WzUXRibbon.Controls
{
    ...
    public class InRibbonGallery : Selector, IScalableRibbonControl, IDropDownControl, IRibbonControl, IQuickAccessItemProvider, IRibbonSizeChangedSink, ILargeIconProvider, IMediumIconProvider, ISimplifiedRibbonControl
    {
        ...
        /// </summary>
        public static readonly DependencyProperty KeyTipProperty = WzUXRibbon.Controls.KeyTip.KeysProperty.AddOwner(typeof(InRibbonGallery));
        ...
        private static void OnIsDropDownOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (UIElementAutomationPeer.FromElement(inRibbonGallery) is WzUXRibbon.Automation.Peers.RibbonInRibbonGalleryAutomationPeer peer)
            {
            ...
            if (newValue)
            {
                ...
                if (inRibbonGallery.controlPresenter != null)
                {
                    inRibbonGallery.controlPresenter.Content = inRibbonGallery.snappedImage;
                }

                if (inRibbonGallery.galleryPanel != null)
                {
                ...
                if (inRibbonGallery.popupControlPresenter != null)
                {
                ...
                if (inRibbonGallery.DropDownPopup?.Child != null)
                {
        ...
        protected override void OnSelectionChanged(SelectionChangedEventArgs e)
        {
            ...
            if ((!AutomationPeer.ListenerExists(AutomationEvents.SelectionPatternOnInvalidated)
                ...
                || !(UIElementAutomationPeer.CreatePeerForElement(this) is WzUXRibbon.Automation.Peers.RibbonInRibbonGalleryAutomationPeer))
            {
                return;
            }

            var peerForElement = UIElementAutomationPeer.CreatePeerForElement(this) as WzUXRibbon.Automation.Peers.RibbonInRibbonGalleryAutomationPeer;
        ...
        {
            // Ignore mouse up when mouse down is on expand button
