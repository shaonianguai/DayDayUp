...
namespace WzUXRibbon.Controls
{
    ...
    public class RibbonTabControl : Selector, IDropDownControl, ILogicalChildSupport
    {
        ...
        /// <summary>
        /// Provides a value needed to add space to the popup to accommodate for overlapping key tips.
        /// </summary>
        ...
        protected override void OnPreviewMouseWheel(MouseWheelEventArgs e)
        {
            ...
            if (Mouse.Captured is IDropDownControl popup
                && popup.IsDropDownOpen == true
                && popup.DropDownPopup != null)
            {
                e.Handled = popup.DropDownPopup.IsMouseOver;
                return;
            }
        ...
        private RibbonTabItem FindNextTabItem(int startIndex, int direction)
        {
            if (direction != 0)
            {
                ...
                for (var i = 0; i < this.Items.Count; i++)
                {
                    ...
                    var nextItem = this.ItemContainerGenerator.ContainerOrContainerContentFromIndex<RibbonTabItem>(index);
                    if (nextItem != null
                        && nextItem.IsEnabled
        ...
        private unsafe CustomPopupPlacement[] CustomPopupPlacementMethod(Size popupsize, Size targetsize, Point offset)
        {
            ...
            var tabItemOriginPointOnScreenRect = new NativeMethods.RECT
            {
            ...
            var monitor = NativeMethods.MonitorFromRect(ref tabItemOriginPointOnScreenRect, NativeMethods.MONITOR_FROM_FLAGS.MONITOR_DEFAULTTONEAREST);
