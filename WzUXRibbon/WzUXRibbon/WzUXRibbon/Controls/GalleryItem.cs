...
namespace WzUXRibbon.Controls
{
    public class GalleryItem : ListBoxItem, IKeyTipedControl, ICommandSource
    {
        ...
        /// </summary>
        public static readonly DependencyProperty KeyTipProperty = WzUXRibbon.Controls.KeyTip.KeysProperty.AddOwner(typeof(GalleryItem));
        ...
        /// <summary>
        /// Gets or sets the command to invoke when mouse enters or leaves this button. The command parameter will be the <see cref="GalleryItem"/> instance.
        /// This is a dependency property.
        /// </summary>
        [Bindable(true)]
        [Category("Action")]
