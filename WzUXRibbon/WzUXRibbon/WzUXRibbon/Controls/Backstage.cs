...
namespace WzUXRibbon.Controls
{
    ...
    public class Backstage : RibbonControl
    {
        ...
        private static void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            (UIElementAutomationPeer.FromElement(control) as WzUXRibbon.Automation.Peers.RibbonBackstageAutomationPeer)?.RaiseExpandCollapseAutomationEvent(oldValue, newValue);
        }
        ...
        /// <summary>
        /// Gets or sets whether backstage can be opened or closed.
        /// </summary>
        ...
        protected virtual void OnDismissPopup(object sender, DismissPopupEventArgs e)
        {
            ...
            // Only close backstage when pop-up should always be closed.
        ...
        private void CreateAndAttachBackstageAdorner()
        {
            ...
            {
                while (UIHelper.GetParent<AdornerDecorator>(elementToAdorn) is AdornerDecorator currentAdornerDecorator
                    && currentAdornerDecorator != null)
                {
        ...
        /// <inheritdoc />
        protected override AutomationPeer OnCreateAutomationPeer() => new WzUXRibbon.Automation.Peers.RibbonBackstageAutomationPeer(this);
    }
}
