...
namespace WzUXRibbon.Controls
{
    ...
    public class RibbonTabItem : Control, IKeyTipedControl, IHeaderedControl, ILogicalChildSupport, ISimplifiedStateControl
    {
        ...
        /// </summary>
        public static readonly DependencyProperty KeyTipProperty = WzUXRibbon.Controls.KeyTip.KeysProperty.AddOwner(typeof(RibbonTabItem));
        ...
        // handles Group property changed
        ...
        public RibbonTabItem()
        {
            ...
            // Force redirection of DataContext. This is needed, because we detach the container from the visual tree and attach it to a different one (the popup/dropdown) when the ribbon is minimized.
        ...
        public KeyTipPressedResult OnKeyTipPressed()
        {
            ...
            // This way key tips for delay loaded elements work correctly. Partially fixes #244.
