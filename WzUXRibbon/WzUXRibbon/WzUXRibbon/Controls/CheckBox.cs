...
namespace WzUXRibbon.Controls
{
    ...
    public class CheckBox : System.Windows.Controls.CheckBox, IRibbonControl, IQuickAccessItemProvider, ILargeIconProvider, IMediumIconProvider, ISimplifiedRibbonControl
    {
        ...
        /// </summary>
        public static readonly DependencyProperty KeyTipProperty = Controls.KeyTip.KeysProperty.AddOwner(typeof(CheckBox));
        ...
        public static readonly DependencyProperty HeaderTemplateSelectorProperty = RibbonControl.HeaderTemplateSelectorProperty.AddOwner(typeof(CheckBox), new PropertyMetadata());
