...
namespace WzUXRibbon.Controls
{
    ...
    public class RadioButton : System.Windows.Controls.RadioButton, IRibbonControl, IQuickAccessItemProvider, ILargeIconProvider, IMediumIconProvider, ISimplifiedRibbonControl
    {
        ...
        /// </summary>
        public static readonly DependencyProperty KeyTipProperty = WzUXRibbon.Controls.KeyTip.KeysProperty.AddOwner(typeof(RadioButton));
        ...
        /// <inheritdoc />
        protected override AutomationPeer OnCreateAutomationPeer() => new WzUXRibbon.Automation.Peers.RibbonRadioButtonAutomationPeer(this);
    }
}
